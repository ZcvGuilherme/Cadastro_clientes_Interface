...
class Application():
    ...
    def Entradas(self):
        ...
        #----------------------------------ENTRY EMAIL------------------------------------------------#
        self.entry_email = Entry(self.frame1, justify='left', font=('Nirmala UI', 12, 'bold'),bd= 2, cursor='xterm', highlightcolor='#9ACD32', highlightthickness=2, fg='gray')
        ...
        self.label_email = Label(self.frame1, justify='center', font=('Verdana', 15, 'bold'), text='Email', bg='#f0f0f0',border=2, relief='groove', padx=1, pady=1)
        self.label_email.place(relx=0.08, rely=0.26, relheight=0.09, relwidth=0.3)
        #----------------------------------ENTRY GENERO-----------------------------------------------#
        self.label_genero = Label(self.frame1, justify='center', font=('Verdana', 15, 'bold'), text='Gênero', bg='#f0f0f0', border=2, relief='groove')
        self.label_genero.place(relx=0.7, rely=0.01, relheight=0.08, relwidth=0.17)
        #opção masculino
        self.masculino_var = IntVar()
        self.masculino_check = Checkbutton(self.frame1, text="Masculino",font=('Calibri', 16), variable=self.masculino_var, justify='left', bg='#c6c6c6',command=self.select_masculino, relief= 'flat', activebackground='#c0dcc0')
        self.masculino_check.place(relx=0.65, rely=0.1, relheight=0.07, relwidth=0.3)
        #opção feminino
        self.feminino_var = IntVar()
        self.feminino_check = tk.Checkbutton(self.frame1, text="Feminino",font= ('Calibri', 16),variable=self.feminino_var,justify='left',bg='#c6c6c6',activebackground= '#c0dcc0',command=self.select_feminino, selectcolor='white', relief='flat')
    ...
    def botoes(self):
        ...
        self.salvar_Button = Button(self.frame1, image=self.salvar_img, relief='flat', bd=4, bg='#c6c6c6')
        self.salvar_Button.place(relx=0.9, rely=0.85, relheight=0.13, relwidth=0.1)

        self.apagar_img = PhotoImage(file='fechar.png')
        self.apagar_Button = Button(self.frame1, image=self.apagar_img, relief='flat', bd=4, bg='#c6c6c6')
        self.apagar_Button.place(relx=0.75, rely=0.85, relheight=0.13, relwidth=0.1)
